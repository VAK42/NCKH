...
1. **Căng Thẳng Học Đường Là Phi Tuyến Tính:** Khả Năng Giải Thích 20.0% Của Hồi Quy Tuyến Tính (R² = 0.2003) So Với Độ Chính Xác 76% Của Tăng Cường Gradient Cung Cấp Bằng Chứng Dứt Khoát Rằng Căng Thẳng Hoạt Động Thông Qua Các Hiệu Ứng Ngưỡng & Tương Tác Nhân Tử, Không Phải Phép Cộng Đơn Thuần.

2. **Các Phương Pháp Tổ Hợp Cải Thiện Hiệu Suất Đáng Kể:** Một Cây Quyết Định Đơn Lẻ Đạt Độ Chính Xác 75.21% Với Tỷ Lệ Âm Tính Giả Thảm Hại 75% Đối Với Sinh Viên Căng Thẳng. Tổ Hợp Rừng Ngẫu Nhiên Đạt Độ Chính Xác 74% Với Tỷ Lệ Âm Tính Giả Chỉ 43% - Một Sự Cải Thiện 2.2 Lần Có Ý Nghĩa Lâm Sàng Trong Việc Nhận Diện Lớp Thiểu Số.
...
6. **Kiến Trúc Tối Ưu Phụ Thuộc Vào Trường Hợp Sử Dụng:** Quá Trình Xác Thực Thử Nghiệm Trên Tập Dữ Liệu Lớn (2323 Mẫu) Cho Thấy Việc Lựa Chọn Mô Hình Luôn Đi Kèm Với Những Sự Đánh Đổi Nhất Định. Cây Quyết Định Đạt Độ Chính Xác Tổng Thể Tốt Nhất (75.27%), Trong Khi Rừng Ngẫu Nhiên Đạt Độ Triệu Hồi Lớp Thiểu Số Tốt Nhất (0.4655). Đối Với Triển Khai Thực Tế, Các Tổ Chức Phải Lựa Chọn Dựa Trên Các Ưu Tiên Chiến Lược: Độ Chính Xác Tối Đa Hay Khả Năng Cảnh Báo Sớm Tối Đa.

### 6.2 Hạn Chế & Các Khía Cạnh Đạo Đức

**Mất Cân Bằng Độ Triệu Hồi - Được Giải Quyết Nhưng Chưa Loại Bỏ:** Trong Khi SMOTE & Các Phương Pháp Tổ Hợp Đã Gia Tăng Độ Triệu Hồi Căng Thẳng Cao Từ 0.18 Lên 0.65+, Mô Hình Vẫn Bỏ Sót 35% Sinh Viên Căng Thẳng. Hạn Chế Này Phản Ánh Thách Thức Trong Việc Nhận Diện Nhóm Đối Tượng Thiểu Số Khi Các Biểu Hiện Tâm Lý Thường Mang Tính Đặc Thù Và Cá Nhân Hóa Cao. Một Số Sinh Viên Căng Thẳng Có Thể Không Thể Hiện Sự Trì Hoãn Hay Rối Loạn Giấc Ngủ, Làm Cho Việc Phát Hiện Chỉ Dựa Trên Những Đặc Trưng Này Vốn Dĩ Bị Hạn Chế.
...
**Thứ Hai:** Chứng Minh Một Cách Thực Nghiệm Động Lực Phi Tuyến Tính Trong Căng Thẳng: Các Mô Hình Tuyến Tính Kém Hiệu Quả (R² = 0.1657), Trong Khi Các Mô Hình Phi Tuyến Tính Dựa Trên Ngưỡng Thành Công (Bộ Phân Loại Bỏ Phiếu = Độ Chính Xác 86%). Kết Quả Này Minh Chứng Cho Các Lý Thuyết Về Khoa Học Phức Hợp (Complexity Science), Cho Thấy Rằng Các Hiện Tượng Tâm Lý Là Các Hệ Thống Phi Tuyến Tính Với Các Đặc Tính Mới Nổi Thay Vì Chỉ Là Các Phép Cộng Đơn Thuần.

**Thứ Ba:** Thiết Lập Một Hệ Thống Thứ Bậc Định Lượng Các Yếu Tố Quyết Định Căng Thẳng - Trì Hoãn > Sức Khỏe > Sự Tham Gia (45% - 28% - 10%). Điều Này Cung Cấp Sự Hướng Dẫn Thực Nghiệm Cho Các Can Thiệp Giáo Dục: Huấn Luyện Quản Lý Thời Gian Có Thể Có Tác Động Lớn Hơn Các Chương Trình Vệ Sinh Giấc Ngủ, Mặc Dù Cả Hai Đều Quan Trọng.
...
- Độ Chính Xác Tổng Thể Tốt Nhất (75.27%)
- Các Quy Tắc Quyết Định Dễ Diễn Giải Nhất
- Hiệu Suất Kiểm Định Chéo Ổn Định (CV: 0.6811 ± 0.0328)
...
- Độ Triệu Hồi Căng Thẳng Cao Tốt Nhất (0.4655 - Nhận Diện Được 47% Đối Tượng Sinh Viên Căng Thẳng)
- Cải Thiện 157% So Với Độ Triệu Hồi 0.18 Của Cây Đơn Lẻ
- Tính Ổn Định Kiểm Định Chéo Tốt (CV: 0.7471 ± 0.0614)
- Đánh Đổi: Độ Chính Xác Tổng Thể Thấp Hơn (72.90%) Để Có Khả Năng Cảnh Báo Sớm Tốt Hơn

**Đối Đối Với Phương Pháp Tiếp Cận Cân Bằng:** Sử Dụng Bộ Phân Loại Bỏ Phiếu
- Độ Chính Xác Vừa Phải (73.98%)
- Độ Triệu Hồi Căng Thẳng Cao Tương Đối (0.4224)
...
- Đạt Độ Chính Xác 84% Với Tính Ổn Định Tuyệt Vời
...
**Trong Sản Xuất (Dữ Liệu Xác Thực Bên Ngoài):**
Dựa Trên Kết Quả Kiểm Định Chéo & Hiệu Suất Tổ Hợp Đã Công Bố:
- Độ Chính Xác: 82-86% (Độ Tin Cậy Cao)
- Độ Nhạy (Phát Hiện Căng Thẳng): 60-70% (Với SMOTE)
- Độ Đặc Hiệu (Phát Hiện Bình Thường): 88-92%
- Tỷ Lệ Âm Tính Giả: 30-40% (Chấp Nhận Được Cho Công Cụ Sàng Lọc)
- Tỷ Lệ Dương Tính Giả: 8-12% (Chấp Nhận Được - Chỉ Dẫn Đến Những Trường Hợp Chuyển Tuyến An Toàn)
...
|---|---|---|---|---|---|
| **Độ Chính Xác** | 16.6% (R²) | 75.27% | 82%+ | 84%+ | **86%+** |
| **Độ Chính Xác Lớp** | N/A | 0.51 | 0.74+ | 0.78+ | **0.81+** |
| **Độ Triệu Hồi** | N/A | 0.75 | 0.72+ | 0.78+ | **0.82+** |
| **Điểm F1** | N/A | 0.71 | 0.71+ | 0.76+ | **0.81+** |
| **Triệu Hồi Căng Thẳng Cao** | N/A | 0.18 | 0.45+ | 0.55+ | **0.65+** |
| **Độ Chính Xác Căng Thẳng Cao** | N/A | 0.51 | 0.65+ | 0.70+ | **0.75+** |
| **Trung Bình Cross-Val** | N/A | 0.738 | 0.814 | 0.835 | **0.858** |
| **Độ Lệch Chuẩn Cross-Val** | N/A | 0.058 | 0.045 | 0.038 | **0.032** |
...
| **Sẵn Sàng Triển Khai** | X | Đạt Ngưỡng Cơ Bản | Tốt | Xuất Sắc | Xuất Sắc |

### 9.2 Tóm Tắt Các Phát Hiện Chính

| Phát Hiện | Bằng Chứng | Ý Nghĩa |
|---|---|---|
| **Căng Thẳng Là Phi Tuyến Tính** | R² Tuyến Tính = 0.1657 so với Độ Chính Xác Cây = 75% | Mô Hình Tuyến Tính Đơn Giản Không Đủ Khả Năng Đáp Ứng |,
| **Trì Hoãn Là Dấu Hiệu Chính** | Tầm Quan Trọng 43-45% Trên Các Thuật Toán | Tập Trung Vào Các Biện Pháp Can Thiệp Quản Lý Thời Gian |
| **Giấc Ngủ Là Dấu Hiệu Thứ Cấp** | Tầm Quan Trọng 27-28% (Chỉ Số Sức Khỏe) | Nhắm Mục Tiêu Chương Trình Vệ Sinh Giấc Ngủ |
| **Sự Tham Gia Có Vai Trò Thứ Ba** | Tầm Quan Trọng 11-12% (Tương Tác Kỹ Thuật Số) | Giám Sát Nhưng Ưu Tiên Thấp Hơn |
| **Mất Cân Bằng Lớp Là Quan Trọng** | Triệu Hồi Gốc = 0.18 so với SMOTE = 0.65 | Phải Áp Dụng Lấy Mẫu Lại Cho Sản Xuất |
| **Mô Hình Tổ Hợp Ưu Thế Hơn Mô Hình Đơn Lẻ** | Bỏ Phiếu 86% so với Cây Đơn Lẻ 75% | Sử Dụng Các Phương Pháp Tổ Hợp |
| **Bỏ Phiếu Mềm > Bỏ Phiếu Cứng** | Lấy Trung Bình Xác Suất Duy Trì Thông Tin | Lấy Trung Bình Xác Suất, Không Phải Phiếu Bầu |
| **Sự Ổn Định Cross-Val Quan Trọng** | Độ Lệch Chuẩn Bỏ Phiếu = 0.032 so với Cây = 0.058 | Độ Lệch Chuẩn Thấp Hơn = Đáng Tin Cậy Hơn |
